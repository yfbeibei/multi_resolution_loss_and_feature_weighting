...
# parameters for IOCformer
parser.add_argument('--dm_count', action='store_true',
                    help="add a small branch to train a density map if true")
parser.add_argument('--branch_merge_way', type=int, default=2,
                    help="how to merge the branch")
parser.add_argument('--only_dm', action='store_true',
                    help="add a small branch to train a density map if true")
parser.add_argument('--visual_path', type=str, default='',
                    help="visualization path")
parser.add_argument('--branch_merge', action='store_true',
                    help="whether to merge two branches")
...
parser.add_argument('--decoding_arch', default='multi_resolution_loss', type=str,
                    help="transformer flag controls which transformer to use")
